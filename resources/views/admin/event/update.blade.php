                                    ...
                                    <div class="card-body">
                                        <div class="form-group {{ $errors->first('e_name') ? 'has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" name="e_name"
                                                value="{{ $event->e_name }}" placeholder="Name ...">
                                        ...
                                        <div class="form-group {{ $errors->first('e_link') ? 'has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" name="e_link"
                                                value="{{ $event->e_link }}" placeholder="Link ...">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-2">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="checkbox" name="e_position_1"
                                                        {{ $event->e_position_1 ?? 0 == 1 ? "checked='checked'" : '' }}
                                                        value="1">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="checkbox" name="e_position_2"
                                                        {{ $event->e_position_2 ?? 0 == 1 ? "checked='checked'" : '' }}
                                                        value="1">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="checkbox" name="e_position_3"
                                                        {{ $event->e_position_3 ?? 0 == 1 ? "checked='checked'" : '' }}
                                                        value="1">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="checkbox" name="e_position_4"
                                                        {{ $event->e_position_4 ?? 0 == 1 ? "checked='checked'" : '' }}
                                                        value="1">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body" style="min-height: 288px">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger ">
                                                <p class="mg-t-5">{{ $errors->first('e_banner') }}</p>
                                            </span>
                                            @if (isset($event) && !empty($event->e_banner))
                                                <img src="{{ !str_starts_with($event->e_banner, '/') ? '/' . $event->e_banner : $event->e_banner }}"
