        ...
        <div class="card">
                ...
                <div class="left">
                    ...
                    <a href="{{ route('get.product.detail', $product->pro_slug . '-' . $product->id) }}" title=""
                        ...
                        <img alt="" style="max-width: 100%;width: 100%;height: auto"
                            src="{{ '/' . $product->pro_image_version }}" class="lazyload">
                    </a>
                    <p style="display: flex;align-items: center;justify-content: center;margin-top: 20px"><a href="#ex1"
                            rel="modal:open" class="btn btn-success" style="background-color:#288ad6;">Xem
                            Album ảnh ({{ $images->count() ?? 0 }})</a></p>
            ...
            @if (!empty($product->pro_content))
                <div class="reviews content_text" style="float: left; width: 100%;">
                    <h4 class="reviews-title"><b class="product_details_title"
                            style="color: cornflowerblue; font-weight: 700">Chi tiết sản phẩm</b></h4>
