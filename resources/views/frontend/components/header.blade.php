        ...
        <div class="container header-wrapper">
            ...
            <div class="logo">
                <a href="/" class="desktop">
                    <img src="{{ url('images/logoD.png') }}" style="height: 55px;" alt="Home">
                </a>
                <span class="menu js-menu-cate"><i class="btn-open-menu fas fa-bars"
                        style="color: rgb(1, 23, 7)"></i></span>
            </div>
            <div class="search">
                ...
                <form action="{{ $link_search ?? route('get.product.list', ['k' => Request::get('k')]) }}"
                    ...
                    <input type="text" name="k" value="{{ Request::get('k') }}" class="form-control"
                        placeholder="Tìm kiếm sản phẩm ..." style="font-style: normal">
                    ...
                    @foreach ($categories as $item)
                        <li>
                            <a href="{{ route('get.category.list', $item->c_slug . '-' . $item->id) }}"
                                ...
                                <img src="{{ !str_starts_with($item->c_avatar, '/') ? '/' . $item->c_avatar : $item->c_avatar }}"
                                    alt="{{ $item->c_name }}">
